  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Just navigate to email verification page with email in state
      ...
      <div className="w-full max-w-3xl relative z-10 fade-up scale-in px-3 sm:px-4">
        <div className="bg-white/60 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 md:p-12 border border-white/40 hover:shadow-[0_20px_60px_rgba(245,189,166,0.3)] transition-all duration-500">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="fade-up" style={{ animationDelay: "0.1s" }}>
                ...
                <div className="relative group">
                  <input
                    ...
                    required
                    className="w-full px-5 py-3.5 rounded-2xl bg-white/70 backdrop-blur-sm placeholder:text-[#A0A0A0] text-[#1E1E1E] border-2 border-white/50 focus:border-[#F5BDA6] focus:bg-white/90 focus:outline-none transition-all duration-300 shadow-sm hover:shadow-md"
                  />
              ...
              <div className="fade-up" style={{ animationDelay: "0.4s" }}>
                ...
                <div className="relative group">
                  <select
                    ...
                    value={form.gender}
                    onChange={handleChange}
                    className="w-full px-5 py-3.5 rounded-2xl bg-white/70 backdrop-blur-sm text-[#1E1E1E] border-2 border-white/50 focus:border-[#A7CDA9] focus:bg-white/90 focus:outline-none transition-all duration-300 shadow-sm hover:shadow-md appearance-none cursor-pointer"
                  >
            ...
            {/* Submit Button */}
            <div className="pt-4 fade-up" style={{ animationDelay: "0.5s" }}>
              <button
                type="submit"
                disabled={loading}
